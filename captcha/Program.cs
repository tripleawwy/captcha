    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Thread.Sleep(300);
                image.Save(@"C:\Users\bjoer\Desktop\test6.png", ImageFormat.Png);
                Rectangle beschnittenesRechteck = new Rectangle(20, 120, 250, 190);
                //Bitmap original = image;
                Bitmap original = Image.FromFile(@"C:\Users\bjoer\Desktop\test1.png") as Bitmap;
                ...
                {
                    g.DrawImage(original, new Rectangle(0, 0, beschnittenesBild.Width, beschnittenesBild.Height),
                                     beschnittenesRechteck,
                                     GraphicsUnit.Pixel);
                }
                beschnittenesBild.Save(@"C:\Users\bjoer\Desktop\test8.png", ImageFormat.Png);
                ...
                var testDocument = @"C:\Users\bjoer\Desktop\test8.png";
